                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group city-outer-bx has-feedback">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        ...
                                                        <select required class="wt-select-box selectpicker"
                                                            ...
                                                            <option value="سعودي"
                                                                {{ old('nationality') == 'سعودي' ? 'selected' : '' }}>
                                                                سعودي/ة</option>
                                                            <option value="أردني"
                                                                {{ old('nationality') == 'أردني' ? 'selected' : '' }}>
                                                                أردني/ة</option>
                                                            <option value="مصري"
                                                                {{ old('nationality') == 'مصري' ? 'selected' : '' }}>مصري/ة
                                                            </option>
                                                            <option value="سوداني"
                                                                {{ old('nationality') == 'سوداني' ? 'selected' : '' }}>
                                                                سوداني/ة</option>
                                                            <option value="فلسطيني"
                                                                {{ old('nationality') == 'فلسطيني' ? 'selected' : '' }}>
                                                                فلسطيني/ة</option>
                                                            <option value="لبناني"
                                                                {{ old('nationality') == 'لبناني' ? 'selected' : '' }}>
                                                                لبناني/ة</option>
                                                            <option value="سوري"
                                                                {{ old('nationality') == 'سوري' ? 'selected' : '' }}>سوري/ة
                                                            </option>
                                                            <option value="يمني"
                                                                {{ old('nationality') == 'يمني' ? 'selected' : '' }}>يمني/ة
                                                            </option>
                                                            <option value="تونسي"
                                                                {{ old('nationality') == 'تونسي' ? 'selected' : '' }}>
                                                                تونسي/ة</option>
                                                            <option value="مغربي"
                                                                {{ old('nationality') == 'مغربي' ? 'selected' : '' }}>
                                                                مغربي/ة</option>
                                                            <option value="جزائري"
                                                                {{ old('nationality') == 'جزائري' ? 'selected' : '' }}>
                                                                جزائري/ة</option>
                                                            <option value="ليبي"
                                                                {{ old('nationality') == 'ليبي' ? 'selected' : '' }}>ليبي/ة
                                                            </option>
                                                            <option value="أرتيري"
                                                                {{ old('nationality') == 'أرتيري' ? 'selected' : '' }}>
                                                                أرتيري/ة</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group city-outer-bx has-feedback">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker" name="sex"
                                                            ...
                                                            data-bv-field="size">
                                                            <option disabled {{ old('sex') == '' ? 'selected' : '' }}
                                                                value="">
                                                                حدد الجنس
                                                            </option>
                                                            <option value="ذكر"
                                                                {{ old('sex') == 'ذكر' ? 'selected' : '' }}>
                                                                ذكر
                                                            </option>
                                                            <option value="انثى"
                                                                {{ old('sex') == 'انثى' ? 'selected' : '' }}>
                                                                انثى
                                                            </option>
                                                            <option value="كلاهما"
                                                                {{ old('sex') == 'كلاهما' ? 'selected' : '' }}>
                                                                كلاهما
                                                            </option>
                                                        </select>
                                                ...
                                                <div class="form-group city-outer-bx has-feedback">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker" name="city"
                                                            data-live-search="true" title="" id="j-category"
                                                            data-bv-field="size">
                                                            <option disabled {{ old('city') == '' ? 'selected' : '' }}
                                                                value="">
                                                                حدد المدينة
                                                            </option>
                                                ...
                                                <div class="form-group city-outer-bx has-feedback">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker"
                                                            ...
                                                            data-bv-field="size">
                                                            <option disabled
                                                                {{ old('available_work_from_another_place') == '' ? 'selected' : '' }}
                                                                value="">
                                                                حدد
                                                            </option>
                                                            <option value="1"
                                                                {{ old('available_work_from_another_place') == 1 ? 'selected' : '' }}>
                                                                نعم
                                                            </option>
                                                            <option value="2"
                                                                {{ old('available_work_from_another_place') == 2 ? 'selected' : '' }}>
                                                                لا
                                                            </option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="wt-select-box selectpicker" data-live-search="true"
                                                        ...
                                                        <option value="ثانوي"
                                                            {{ old('academy_certificate') == 'ثانوي' ? 'selected' : '' }}>
                                                            ثانوي
                                                        </option>
                                                        <option value="دبلوم"
                                                            {{ old('academy_certificate') == 'دبلوم' ? 'selected' : '' }}>
                                                            دبلوم
                                                        </option>
                                                        <option value="بكالوريوس"
                                                            {{ old('academy_certificate') == 'بكالوريوس' ? 'selected' : '' }}>
                                                            بكالوريوس
                                                        </option>
                                                        <option value="ماستر"
                                                            {{ old('academy_certificate') == 'ماستر' ? 'selected' : '' }}>
                                                            ماستر
                                                        </option>
                                                        <option value="دكتوراة"
                                                            {{ old('academy_certificate') == 'دكتوراة' ? 'selected' : '' }}>
                                                            دكتوراة
                                                        </option>
                                                    </select>
                                                </div>
                                                        ...
                                                        <select class="wt-select-box selectpicker" name="job-category"
                                                            ...
                                                            @foreach ($nameJobsCategories as $jobcategory)
                                                                <option value="{{ $jobcategory['id'] }}"
                                                                    {{ old('job-category') == $jobcategory['id'] ? 'selected' : '' }}>
                                                                    {{ $jobcategory['name'] }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker"
                                                            ...
                                                            @foreach ($specialistsCategories as $specialcategory)
                                                                <option value="{{ $specialcategory['id'] }}"
                                                                    {{ old('special_category') == $specialcategory['id'] ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group city-outer-bx has-feedback">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker" multiple
                                                            name="language[]" data-live-search="true"
                                                            title="حدد اللغة المطلوبة" id="language-select"
                                                            data-bv-field="size">
                                                            <option value="عربي"
                                                                {{ in_array('عربي', old('language', [])) ? 'selected' : '' }}>
                                                                عربي
                                                            </option>
                                                            <option value="انجليزي"
                                                                {{ in_array('انجليزي', old('language', [])) ? 'selected' : '' }}>
                                                                انجليزي
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group city-outer-bx has-feedback">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker"
                                                            ...
                                                            id="language-level-select" data-bv-field="size">
                                                            <option disabled selected value=""> حدد</option>
                                                            <option value="مبتدأ"
                                                                {{ old('language_level') == 'مبتدأ' ? 'selected' : '' }}>
                                                                مبتدأ
                                                            </option>
                                                            <option value="متوسط"
                                                                {{ old('language_level') == 'متوسط' ? 'selected' : '' }}>
                                                                متوسط
                                                            </option>
                                                            <option value="متقدم"
                                                                {{ old('language_level') == 'متقدم' ? 'selected' : '' }}>
                                                                متقدم
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker"
                                                            ...
                                                            <option disabled selected value=""> حدد</option>
                                                            <option value="جزئي"
                                                                {{ old('new_work_time') == 'جزئي' ? 'selected' : '' }}>
                                                                جزئي
                                                            </option>
                                                            <option value="كامل"
                                                                {{ old('new_work_time') == 'كامل' ? 'selected' : '' }}>
                                                                كامل
                                                            </option>
                                                            <option value="مؤقت"
                                                                {{ old('new_work_time') == 'مؤقت' ? 'selected' : '' }}>
                                                                مؤقت
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker" name="new_age"
                                                            ...
                                                            <option disabled selected value=""> حدد</option>
                                                            <option value="18-24"
                                                                {{ old('new_age') == '18-24' ? 'selected' : '' }}>
                                                                18-24
                                                            </option>
                                                            <option value="25-29"
                                                                {{ old('new_age') == '25-29' ? 'selected' : '' }}>
                                                                25-29
                                                            </option>
                                                            <option value="30-39"
                                                                {{ old('new_age') == '30-39' ? 'selected' : '' }}>
                                                                30-39
                                                            </option>
                                                            <option value="+40"
                                                                {{ old('new_age') == '+40' ? 'selected' : '' }}>
                                                                +40
                                                            </option>
                                                            <option value="لايهم"
                                                                {{ old('new_age') == 'لايهم' ? 'selected' : '' }}>
                                                                لايهم
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group city-outer-bx has-feedback">
                                                    ...
                                                    <div class="ls-inputicon-box">
                                                        <select required class="wt-select-box selectpicker"
                                                            ...
                                                            title="" id="notification_timeslot"
                                                            data-bv-field="size">
                                                            <option disabled selected value=""> حدد</option>
                                                            <option value="فوري"
                                                                {{ old('notification_timeslot') == 'فوري' ? 'selected' : '' }}>
                                                                فوري
                                                            </option>
                                                            <option value="خلال شهر"
                                                                {{ old('notification_timeslot') == 'خلال شهر' ? 'selected' : '' }}>
                                                                خلال شهر
                                                            </option>
                                                            <option value="خلال شهرين"
                                                                {{ old('notification_timeslot') == 'خلال شهرين' ? 'selected' : '' }}>
                                                                خلال شهرين
                                                            </option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="job_requirements">{{ old('job_requirements') }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="job_experience">{{ old('job_experience') }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="job_advantage">{{ old('job_advantage') }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="job_needed">{{ old('job_needed') }}</textarea>
                                                </div>
                                            </div>
