        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ خطط الاشتراكات   </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{url('admin/plan/store')}}" class="btn btn-primary btn-sm"> اضافة خطة جديدة <i class="fa fa-plus"></i> </a>
                </div>
                            ...
                            <table class="table text-md-nowrap" id="example2">
                                ...
                                @foreach($plans as $plan)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/plan/update/'.$plan['id'])}}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> </a>
                                            <button data-target="#delete_model_{{$plan['id']}}"
