        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="{{ url('admin/plan/store') }}"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input required type="number" min="1" max="12" class="form-control" name="timeslot" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input required type="number" min="1"  class="form-control" name="price" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea required class='form-control' name='advantage' rows="10"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                            ...
                            <button class='btn btn-primary' type='submit'> اضافة خطة <i class="fa fa-plus"></i> </button>
                        </div>
                    </form>
