        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/  تصنيف التخصصات المهنية    </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @include('admin.other_settings.SpecialNamesCategories.add')
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-md-nowrap" id="example2">
                                ...
                                @foreach($SpecialCategories as $category)
                                    ...
                                    @include('admin.other_settings.SpecialNamesCategories.edit')
                                    @include('admin.other_settings.SpecialNamesCategories.delete')
                                @endforeach
                                </tbody>
                            </table>
                        </div>
