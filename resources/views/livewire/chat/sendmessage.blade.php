        ...
        @if($selected_conversation)
            <form action="" wire:submit.prevent="sendmessage">
                <div class="input-group" style="border: 1px solid #e9e9e9;border-radius: 2px;">
                    <textarea required class="form-control" wire:model="message_body" placeholder="اكتب رسالة هنا"></textarea>
                    <input type="file" wire:model="file" style="display: none;" id="fileInput">
                    <label style="margin-left: 70px" for="fileInput" class="btn"><i class="fa fa-paperclip"></i></label>
